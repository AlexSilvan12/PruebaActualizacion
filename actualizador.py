...
VERSION_LOCAL_PATH = "version_local.txt"
URL_VERSION = "https://raw.githubusercontent.com/AlexSilvan12/PruebaActualizacion/refs/heads/main/version.txt"  # <- cambia por el tuyo real
...
def ejecutar_instalador(version, url):
    try:
        nombre_instalador = f"Instalador_AppPrueba_{version}.exe"
